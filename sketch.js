...
function preload(){
  ...
  trexduckImage = loadImage("trex_duck.png");
...
function setup() {
  ...
  trex.addAnimation("duck", trexduckImage);
  trex.scale = 0.5;
...
function spawnCrows() {
  if(frameCount % 100 === 0){
    ...
    crow.y = Math.round(random(20, 130));
    crow.addImage(crowImage);
    crow.scale = 0.09;
    crow.velocityX = -(3+3*score/100);
    crow.lifetime = 200;
    crowsGroup.add(crow);
  }
}
